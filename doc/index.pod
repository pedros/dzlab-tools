...
=head2 Get DZLab-tools

We have not yet figured out how to get the new versioning system working properly on windows (so that the users can
checkout and update changes to the source tree.  For now, please grab the most recent version of dzlab-tools in zip
format below, and enjoy:

=over 1

=item * 

L<http://dzlab.pmb.berkeley.edu/tools/dzlab-tools-v0.01.zip> (12-26-2010)
